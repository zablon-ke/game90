...
?>
	...
	<div id="content" class="site-content">
		<div class="container">
			...
			<?php bosa_charity_fundraiser_blog_advertisement_banner(); ?>
			...
			<?php if ( class_exists( 'woocommerce' ) ) { ?>
				...
				<!--Blog Category Cards-->
				<?php get_template_part( 'template-parts/cards-category/cards-category' ); ?>
			<?php } ?>
							...
							<?php
								if( !get_theme_mod( 'disable_pagination', false ) ):
									the_posts_pagination( array(
										...
										'next_text' => '<span>'.esc_html__( 'Next', 'bosa-charity-fundraiser' ) .'</span><span class="screen-reader-text">' . esc_html__( 'Next page', 'bosa-charity-fundraiser' ) . '</span>',
										'prev_text' => '<span>'.esc_html__( 'Prev', 'bosa-charity-fundraiser' ) .'</span><span class="screen-reader-text">' . esc_html__( 'Previous page', 'bosa-charity-fundraiser' ) . '</span>',
										'before_page_number' => '<span class="meta-nav screen-reader-text">' . esc_html__( 'Page', 'bosa-charity-fundraiser' ) . ' </span>',
									));
								endif;
								wp_reset_postdata();
							?>
